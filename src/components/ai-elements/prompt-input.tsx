...
export const PromptInputTextarea = ({
  ...
  <InputGroupTextarea
    className={cn(
      "field-sizing-content min-h-[52px] max-h-48 resize-none border-0 bg-white px-3 py-3 pr-14 text-[14px] leading-6 text-gray-900 shadow-none outline-none placeholder:text-gray-500 placeholder:opacity-100 focus-visible:border-0 focus-visible:ring-0 sm:min-h-[54px] sm:text-[14px]",
      className
    )}
      name="message"
