...
export default function Home() {
  ...
  const navItems = [
    ["Home", Leaf, !hasMessages],
    ["Appointments", CalendarDays, false],
    ["Our Services", Grid2X2, false],
    ["Health Resources", BookOpen, false],
    ["My Records", FileText, false],
    ["Messages", MessageCircleHeart, false],
    ["Support", LifeBuoy, false],
  ] as const;
